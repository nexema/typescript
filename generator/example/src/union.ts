import * as $nex from 'nexema'; 
  ...
  extends $nex.NexemaUnion<MyUnion, "stringField" | "boolField" | "listField">
  implements $nex.NexemaMergeable<MyUnion>, $nex.NexemaClonable<MyUnion>
{
  ...
  public mergeUsing(other: MyUnion): void {
    ...
    switch (other._state.fieldIndex) {
      ...
      case 2:
        this._state.currentValue = Array.from(
          other._state.currentValue as Array<number>
        );
        break;
    }
  }
      ...
      switch (this._state.fieldIndex) {
        ...
        case 2:
          instance._state.currentValue = Array.from(
            this._state.currentValue as Array<number>
          );
          break;
      }
    }
